      ...
      <div className="flex items-center gap-3 relative">
        ...
        {user?.fullName ? (
          <>
            ...
            {isDropdownOpen && (
              <div className="absolute shadow-lg py-3 -bottom-14 w-full z-20 flex flex-col gap-2 bg-white border border-gray-200 cursor-pointer">
          ...
          <>
            ...
            {isDropdownOpen && (
              <div className="absolute shadow-lg py-3 -bottom-24 w-full z-20 flex flex-col gap-2 bg-white border border-gray-200 cursor-pointer">
      ...
      <div className="flex items-center gap-3 relative">
        ...
        {user?.fullName ? (
          <>
            ...
            {isDropdownOpen && (
              <div className="absolute shadow-lg py-3 -bottom-14 w-36 -right-0 z-20 flex flex-col gap-2 bg-white border border-gray-200 cursor-pointer">
                <button>Signout</button>
              </div>
            )}
          </>
          ...
          <>
            ...
            {isDropdownOpen && (
              <div className="absolute shadow-lg py-3 -bottom-24 w-36 -right-0 z-20 flex flex-col gap-2 bg-white border border-gray-200 cursor-pointer">
                <button>Sign In</button>
                <button>Sign Up</button>
              </div>
            )}
...
const Navbar = () => {
  return (
    <>
      <nav className="lg:py-2 p-4 flex bg-white shadow-md lg:shadow-none lg:border-b-2 border-gray-100 w-full items-center">
        <MobileNavbar />
        <LargeNav />
      </nav>
    </>
