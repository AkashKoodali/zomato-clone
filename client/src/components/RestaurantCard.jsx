...
const RestaurantCard = (props) => {
  ...
  return (
    ...
    >
      <div className="bg-white p-4 pb-1 w-full h-full rounded-2xl transition duration-700 ease-in-out sm:shadow-md md:shadow-none hover:drop-shadow-lg">
        <div className="w-full relative">
          ...
          <div className="my-2 flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between to-gray-500 gap-10">
